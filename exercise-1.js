...
console.log('Drought periods', droughtPeriods)
...
console.log('Rain periods', rainPeriods)
...
console.log('Optimal pressure and temperature', optimalPressureAndTemperature)
